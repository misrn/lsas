...
class Redisd(object):
    def __init__(self):
        self.RedisConnect = redis.Redis(host=app.config['REDIS_ADDR'], port=app.config['REDIS_PROT'], db=app.config['REDIS_DB'],password=app.config['REDIS_PASSWD'],decode_responses=True)
